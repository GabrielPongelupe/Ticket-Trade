...
-- Inserting data into AVALIACAO table
...
-- Inserting data into DENUNCIA table
...
-- Inserting data into NOTIFICACAO table
...
-- Inserting data into INGRESSO table
...
-- Inserting data into VENDA table
...
-- Inserting data into COMPRA table
